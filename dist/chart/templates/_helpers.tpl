...
*/}}
{{- define "vates-capi.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "vates-capi.resourceName" -}}
{{- $fullname := include "vates-capi.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "vates-capi.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "vates-capi.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
