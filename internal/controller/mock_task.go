...
//
//	mockgen -destination=mock_task.go -package=controller -self_package=git.vates.tech/patrice.ferlet/vates-capi/internal/controller github.com/vatesfr/xenorchestra-go-sdk/pkg/services/library Task,TaskAction
//
